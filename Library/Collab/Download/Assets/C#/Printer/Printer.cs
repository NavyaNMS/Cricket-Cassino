...
public class Printer
{
    ...
    public Printer(string gameTime, string gameDate,
        string totalSelectedSpots,
        string drawTime,
        string barcodeNo, Dictionary<string, BetInfo> bets,float poolPrize,float serviseCharge,GameIds gameIds)
    {
        ...
        switch (gameIds)
        {
            case GameIds.cricket:gameName = "Cricket";
                break;
    ...
    void ProvideContent(object sender, PrintPageEventArgs e)
    {
        ...
        graphics.DrawString($"{gameName} Game Acknowledgement", new Font("Courier New", 14),
